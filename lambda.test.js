...
function testMessages (callback) {

    sqs.receiveMessage({
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/228581499470/BookingInfoQueue',  // URL of your queue
        AttributeNames: ['All'],
            ...
            data.Messages.forEach(message => {      // Going through all the fetched messages in this attempt
                ...
                if (failure) {
                    ...
                    sns.publish({                                   // Notifying booking failure via an SMS message using SNS
                        ...
                        PhoneNumber: '+12012183290'                 // Your phone number goes here to get an SMS notification
                    }).promise()
                        .then(data => {
